...
Plug::Plug(){}
tresult PLUGIN_API Plug::initialize(FUnknown* ctx){auto r=AudioEffect::initialize(ctx); if(r!=kResultOk) return r; addAudioOutput(STR16("Stereo Out"),Vst::SpeakerArr::kStereo); addEventInput(STR16("Event In"),1); return kResultOk;}
